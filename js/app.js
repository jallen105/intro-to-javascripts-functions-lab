...
const isAdult = age => age > 17 ? 'Adult' : 'Minor'
...
const createUsername = (firstName, lastName) => {
    ...
    return `${firstName.substring(0,3)}${lastName.substring(0,3)}${fullName.length}`
}

console.log('Exercise 11 Result:', createUsername("Jonathan", "Allen"));
